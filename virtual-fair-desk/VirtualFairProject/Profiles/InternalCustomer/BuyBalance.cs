...
namespace VirtualFairProject.Profiles.InternalCustomer
{
    public partial class BuyBalance : Form
    {
        ...
        private void btnRegistrarSolicitudCompra_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    purchaseRequest.purchaseRequestProducts = new List<AddProducts>();
            //    purchaseRequest.purchaseRequestProducts.id = 42;
            //    purchaseRequest.purchaseRequestProducts.idProduct = 11;
            //    purchaseRequest.purchaseRequestProducts.weight = 1;
            //    purchaseRequest.purchaseRequestProducts.requieresRefrigeration = 1;
            ...
            foreach (var item in filenamesList)
            {
                ...
                purchaseRequestProducts.requieresRefrigeration = item.requieresRefrigerationBool;
            ...
            if (createBalance.statusCode == 200)
            {
